...
<html><head><meta charset="utf-8"><style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  h1 { font-size: 33px; font-weight: 700; letter-spacing: -0.3px; }
  .sub { font-size: 17px; color: #5b6270; margin-top: 6px; margin-bottom: 30px; }
  ...
  .head {
    ...
    padding: 12px 14px; font-size: 16.5px; font-weight: 680; color: #fff; letter-spacing: 0.1px;
  }
  .head img { height: 22px; width: 22px; object-fit: contain; }
  ...
  .sub-group { border: 1.5px dashed #c3c9d2; border-radius: 8px; padding: 27px 15px 15px; position: relative; }
  .sub-group > .sname {
    position: absolute; top: 5px; left: 0; right: 0; text-align: center;
    font-size: 13.5px; font-weight: 640; color: #5b6270; letter-spacing: 0.2px;
  }
  ...
  .tile span { display: block; font-size: 14px; font-weight: 620; margin-top: 8px; line-height: 1.25; }
  .tile.dark span { color: #eef1f5; }
  .tile.dark img { background: #fff; border-radius: 11px; padding: 7px 9px; box-sizing: content-box; }

  .connector { align-self: center; display: flex; flex-direction: column; align-items: center; padding: 0 10px; min-width: 168px; }
  .connector .line { width: 100%; height: 3px; background: #6f7784; position: relative; }
  .connector .line::after {
    content: ""; position: absolute; right: -1px; top: -6.5px;
    border-left: 14px solid #6f7784; border-top: 8px solid transparent; border-bottom: 8px solid transparent;
  }
  .step { display: flex; align-items: center; gap: 6px; margin-bottom: 6px; }
  .num {
    width: 25px; height: 25px; border-radius: 50%; background: #16181d; color: #fff;
  ...
  .lbl { font-size: 14.5px; color: #2b3038; font-weight: 620; white-space: nowrap; }
  .lbl.on-dark { color: #dfe4ea; }

  .vconn { display: flex; align-items: center; gap: 8px; justify-content: center; padding: 2px 0; }
  .vconn .down { font-size: 24px; color: #aab2be; line-height: 1; }

  .outcome { border: 1.5px solid #dfe3e9; border-radius: 8px; padding: 26px 14px 14px; position: relative; }
  .outcome > .sname {
    position: absolute; top: 5px; left: 0; right: 0; text-align: center;
    font-size: 13.5px; font-weight: 640; color: #5b6270;
  }
  .verdicts { display: flex; gap: 9px; }
  .verdict { flex: 1; border-radius: 7px; padding: 12px 10px; font-size: 14px; font-weight: 680; text-align: center; line-height: 1.3; }
...
<div class="canvas">
  ...
  <div class="group" style="width:292px">
  ...
  <div class="group" style="width:412px">
  ...
  <div class="group panel-cluster" style="width:748px">
    ...
    <div class="body">
      <div class="sub-group dashed-dark">
        ...
        <div class="tiles" style="align-items:center">
          ...
          <div class="connector" style="min-width:140px">
